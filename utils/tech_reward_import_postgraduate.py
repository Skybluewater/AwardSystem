...
from apps.account_profile import CompetitionRecord

competition_table = open_workbook("../excels/award_postgraduate.xlsx").sheet_by_index(4)
...
for row in range(1, competition_table.nrows):
    ...
    CompetitionRecord.objects.create(User=user, SchoolYear=schoolYearID, name=name, holder=holder, awardName=awardName,
                                     competeRange=competeRange, awardLevel=awardValue, otherAward=otherAward, type="ra",
